...
так же в случае если файл был удален для просмотра всех изменений можно ввести команду:
 ...
 Для удобства просмотра логов можно воспользоваться  опцией graph. С ее помощью мы сможем визуально увидеть небольшой граф, который показывает текущую ветку и историю слияний. Вводим в терминал команду: 
